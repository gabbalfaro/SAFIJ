...
public class CatalogoTipoActivo implements Serializable {
	...
	//bi-directional many-to-one association to Biene
	...
	public List<Biene> getBienes() {
		return this.bienes;
	}

	public void setBienes(List<Biene> bienes) {
		this.bienes = bienes;
	}

	public Biene addBiene(Biene biene) {
		getBienes().add(biene);
	...
	public Biene removeBiene(Biene biene) {
